...
async function run() {
  ...
  if (relRes.status === 404) {
    ...
    const releaseNotes = `### الإصدار المستقر v2.3.47 - المرتبات والأجور، الأصول الرأسمالية، ومحرك تركيب خلطات العطور الفوري 🌿✨

- **تبويب المرتبات والأجور (Salaries & Payroll)**: إدارة كاملة للرواتب مع تحديد مصدر الصرف:
  - *درج الكاشير اليومي*: يُخصم من مبيعات الوردية اليومية للكاشير.
  - *الخزينة العامة / رأس المال*: يُصرف من الخزينة المركزية دون التأثير على تقفيل الوردية اليومية.
- **المصروفات الرأسمالية والأصول (Capital Assets & Fixed Machinery)**: قسم للأصول والآلات التي ليس لها سعر جملة (ماكينات كبس العطور، التجهيزات المخبرية، الديكورات)، وتُسحب حصراً من الخزينة العامة كـ CapEx وتظهر في التقارير المالية المستقلة.
- **محرك تركيب خلطات العطور الفوري (POS Blending Engine)**:
  - زر مميز واختصار سريع **F4** في شاشة البيع.
  - حساب تناسبي لمل الزيت الخام والكحول المكمل لمختلف السعات (5، 10، 20، 30، 40، 50، 100، 200 مل).
  - دعم خيار العلب الكرتونية والتغليف الفاخر.
  - حساب فوري وحي لهامش الربح مع خصم واسترجاع ذري للمخزون بالكامل في SQLite.
- **تحديثات الاستقرار**: اجتياز 37 حزمة اختبار و 258 فحصاً آلياً بنسبة 100%.`;
